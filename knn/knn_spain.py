...
knn.fit(xTrain_S_scaled, yTrain_S)

# NOTE: The original dataset for this script is SPAIN
print("Original Dataset: Spain")

# Make predictions on the test set
yTest_pred = knn.predict(xTest_S_scaled)

# Evaluate accuracy on the test set
selfAcc = accuracy_score(yTest_S, yTest_pred)
print("Self-Test Accuracy:", selfAcc)
# Calculate F1 score on the test set
selfF1 = f1_score(yTest_S, yTest_pred, average='weighted')
print("Test F1 Score:", selfF1)

# Evaluate accuracy on other league test sets
yTest_pred1 = knn.predict(xTest_E_scaled)
acc1 = accuracy_score(yTest_E, yTest_pred1)
print("Test Accuracy England:", acc1)
f1_1 = f1_score(yTest_E, yTest_pred1, average='weighted')
...
yTest_pred4 = knn.predict(xTest_G_scaled)
...
data = {
    ...
    'Accuracy': [acc1, selfAcc, acc2, acc3, acc4],
...
plt.title('Accuracy vs. F1 Score Matrix (Original Country: Spain)')
plt.show()