...
yTest_pred = knn.predict(xTest_F_scaled)

# Evaluate accuracy on the test set
selfAcc = accuracy_score(yTest_F, yTest_pred)
print("Self-Test Accuracy:", selfAcc)
# Calculate F1 score on the test set
selfF1 = f1_score(yTest_F, yTest_pred, average='weighted')
...
yTest_pred3 = knn.predict(xTest_E_scaled)
acc3 = accuracy_score(yTest_E, yTest_pred3)
print("Test Accuracy England:", acc3)
f1_3 = f1_score(yTest_E, yTest_pred3, average='weighted')
