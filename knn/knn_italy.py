...
yTest_pred2 = knn.predict(xTest_E_scaled)
...
data = {
    ...
    'Accuracy': [acc2, acc1, selfAcc, acc3, acc4],
...
plt.title('Accuracy vs. F1 Score Matrix (Original Country: Italy)')
plt.show()